...
module.exports = {
  ...
  "RECAPTCHA_PRIV_KEY": process.env.RECAPTCHA_PRIV_KEY || '6LfJtgoUAAAAANdxgY9a7HlOgnflj1SzSyhVetJk',
  "RECAPTCHA_SITE_KEY": process.env.RECAPTCHA_SITE_KEY || '6LfJtgoUAAAAAFjwVTQyZi3nlomRYBN-K8_UWPEt',
